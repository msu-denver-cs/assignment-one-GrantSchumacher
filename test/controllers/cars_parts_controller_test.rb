...
class CarsPartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cars_part" do
    assert_difference('CarsPart.count') do
      post cars_parts_url, params: { cars_part: { make: @cars_part.make, model: @cars_part.model, parts: @cars_part.parts, vin: @cars_part.vin } }
    end
  ...
  test "should update cars_part" do
    patch cars_part_url(@cars_part), params: { cars_part: { make: @cars_part.make, model: @cars_part.model, parts: @cars_part.parts, vin: @cars_part.vin } }
